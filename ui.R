...
shinyUI(navbarPage(HTML(paste0('<a href=',shQuote(saved_url), '>', '<img height="25px" src="data:image/png;base64,"></a>', ' <a href=',shQuote(saved_url), '>OwnYourData', '</a>')), 
                   id="page", collapsible=TRUE, inverse=FALSE, windowTitle='Beziehungsmonitor | OwnYourData', 
                   tabPanel('Beziehungsmonitor',
                            bsAlert("topAlert"),
                            sidebarLayout(
    sidebarPanel(
...
navbarMenu('Infos',
           tabPanel(HTML("Version</a></li><li><a href=\"https://github.com/OwnYourData/app-relationship/blob/master/README.md\">Anleitung"),
                    sidebarLayout(
                            sidebarPanel(
                                    p('Support: ', 
                                    ...
                                    p('Bugtracking: ',
                                      a(href="https://github.com/OwnYourData/app-relationship/issues",
                                        "Github")),
                                    hr(),
                                    p('entwickelt von ',
                                    ...
                                    p('MIT Lizenz, 2016')),
                            mainPanel(
                                    h2('akutelle Version: 0.3.1'),
                                    htmlOutput('upgradeLink'),
                                    hr(),
                                    h3('Versionsverlauf'),
                                    p(strong('Version 0.3.1')),
